...
public class VisStorageHelper {
    ...
    public static float getVisStored(ItemStack stack){
        return Objects.requireNonNull(stack.getCapability(TCCapabilities.VisStorage.ITEM)).getVisStored();
    }
    ...
    public static float getMaxVisStored(ItemStack stack){
        return Objects.requireNonNull(stack.getCapability(TCCapabilities.VisStorage.ITEM)).getMaxVisStored();
    }
    ...
    public static float extractVis(ItemStack stack, float maxExtract){
        return Objects.requireNonNull(stack.getCapability(TCCapabilities.VisStorage.ITEM)).extractVis(maxExtract);
    }
    ...
    public static float receiveVis(ItemStack stack, float maxReceive){
        return Objects.requireNonNull(stack.getCapability(TCCapabilities.VisStorage.ITEM)).receiveVis(maxReceive);
    }

    public static boolean hasVis(ItemStack stack){
        return stack.getCapability(TCCapabilities.VisStorage.ITEM) != null;
    }
