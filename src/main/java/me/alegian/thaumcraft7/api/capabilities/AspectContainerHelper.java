...
public class AspectContainerHelper {
    ...
    public static AspectList getAspects(Level level, BlockPos pos){
        return Objects.requireNonNull(level.getCapability(ThaumcraftCapabilities.AspectContainer.BLOCK, pos, null)).getAspects();
    }

    public static boolean hasAspects(Level level, BlockPos pos){
        return level.getCapability(ThaumcraftCapabilities.AspectContainer.BLOCK, pos, null) != null;
    }
}
