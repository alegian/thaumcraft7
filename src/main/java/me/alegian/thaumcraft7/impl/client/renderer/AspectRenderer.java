...
public class AspectRenderer {
  ...
  public static final float QUAD_SIZE = .5f;
  ...
  public static void renderText(MultiBufferSource bufferSource, PoseStack poseStack, String text) {
    ...
    poseStack.scale(0.036F, -0.036F, 0.036F);
    Font font = Minecraft.getInstance().font;

    font.drawInBatch(text, -font.width(text), -font.lineHeight, 0xFFFFFFFF, true, poseStack.last().pose(), bufferSource, Font.DisplayMode.NORMAL, 0, LIGHT_COLOR, false);
    poseStack.popPose();
  }
