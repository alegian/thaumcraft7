...
public class T7ClientEvents {
  ...
  public static class T7ClientModEvents {
    ...
    public static void registerShaders(RegisterShadersEvent event) throws IOException {
      ...
      event.registerShader(new ShaderInstance(event.getResourceProvider(), ResourceLocation.fromNamespaceAndPath(Thaumcraft.MODID, "line_shader"), DefaultVertexFormat.NEW_ENTITY), shaderInstance -> {
        T7RenderStateShards.simpleLine = shaderInstance;
      });
