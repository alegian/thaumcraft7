...
import me.alegian.thaumcraft7.impl.common.recipe.WorkbenchRecipeSerializer;
...
public class T7RecipeSerializers {
  public static final DeferredRegister<RecipeSerializer<?>> REGISTRAR = DeferredRegister.create(Registries.RECIPE_SERIALIZER, Thaumcraft.MODID);
