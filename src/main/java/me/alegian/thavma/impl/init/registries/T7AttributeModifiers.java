...
public class T7AttributeModifiers {
  public static class StepHeight {
    public static final ResourceLocation LOCATION = Thavma.INSTANCE.rl("step_height");
  ...
  public static class Revealing {
    public static final ResourceLocation LOCATION = Thavma.INSTANCE.rl("revealing");
