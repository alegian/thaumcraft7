...
public class T7Items {
  ...
  public static final DeferredItem<GogglesAccessoryItem> GOGGLES_ACCESSORY = T7Items.REGISTRAR.registerItem("goggles_accessory", GogglesAccessoryItem::new);
  ...
  public static final DeferredItem<ArmorItem> ARCANUM_CHESTPLATE = T7Items.REGISTRAR.registerItem("arcanum_chestplate", props -> new ArmorItem(T7ArmorMaterials.INSTANCE.getARCANUM(), ArmorItem.Type.CHESTPLATE, props), new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(21)));
  public static final DeferredItem<ArmorItem> ARCANUM_LEGGINGS = T7Items.REGISTRAR.registerItem("arcanum_leggings", props -> new ArmorItem(T7ArmorMaterials.INSTANCE.getARCANUM(), ArmorItem.Type.LEGGINGS, props), new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(21)));
  public static final DeferredItem<ArmorItem> ARCANUM_BOOTS = T7Items.REGISTRAR.registerItem("arcanum_boots", props -> new ArmorItem(T7ArmorMaterials.INSTANCE.getARCANUM(), ArmorItem.Type.BOOTS, props), new Item.Properties().durability(ArmorItem.Type.BOOTS.getDurability(21)));
