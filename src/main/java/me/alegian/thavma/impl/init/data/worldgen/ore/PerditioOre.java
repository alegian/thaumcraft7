...
public class PerditioOre {
  ...
  public static Holder<ConfiguredFeature<?, ?>> registerConfigured(BootstrapContext<ConfiguredFeature<?, ?>> context) {
    return OreFeatureHelper.registerConfiguredInfusedStone(context, PerditioOre.CONFIGURED_FEATURE, T7Blocks.INSTANCE.getPERDITIO_INFUSED_STONE().get().defaultBlockState(), T7Blocks.INSTANCE.getPERDITIO_INFUSED_DEEPSLATE().get().defaultBlockState());
  }

  public static Holder<PlacedFeature> registerPlaced(BootstrapContext<PlacedFeature> context) {
    return OreFeatureHelper.registerPlacedInfusedStone(context, PerditioOre.CONFIGURED_FEATURE, PerditioOre.PLACED_FEATURE);
  }
}
